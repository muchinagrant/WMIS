...
export const NEMA_LIMITS = {
    ...
    effluent_turbidity:   5.0,   // NTU  — ⚠️ confirm
    effluent_ph_min:      6.0,
    effluent_ph_max:      9.0,
...
export const EFFLUENT_PARAMS = [
    ...
    { key: 'effluent_fc',          label: 'Fecal Coliforms', unit: 'CFU/100mL',    freq: 'W'  },
...
export const SUMMARY_TABLE_COLS = [
    ...
    { key: 'effluent_turbidity',  label: 'Turb.',    unit: 'NTU'  },
    { key: 'effluent_do',         label: 'DO',       unit: 'mg/L' },
    { key: 'volume_treated_m3',   label: 'Vol. (m³)', unit: ''    },
];
