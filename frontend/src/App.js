    ...
    <div className="container mx-auto max-w-6xl bg-white rounded-lg shadow-lg overflow-hidden my-8" style={{ fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
      <Routes>
        ...
        <Route element={<ProtectedLayout />}>
          ...
          <Route path="/inspection" element={<RoleRoute allowedRoles={['line_supervisor', 'line_attendant']} element={<InspectionTable />} />} />
          ...
          <Route path="/connections" element={<RoleRoute allowedRoles={['line_supervisor', 'line_attendant']} element={<SewerConnections />} />} />
          <Route path="/dispatch" element={<RoleRoute allowedRoles={['line_supervisor', 'line_attendant']} element={<DispatchDashboard />} />} />
          ...
          <Route path="/profile" element={<RoleRoute allowedRoles={['admin', 'stp_superintendent', 'stp_supervisor', 'lab_tech', 'stp_operator', 'stp_attendant', 'line_supervisor', 'line_attendant']} element={<Profile />} />} />
        </Route>
